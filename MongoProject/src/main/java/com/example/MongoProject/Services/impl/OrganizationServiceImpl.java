...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    public ResponseEntity<ApiResponse<OrganizationDTO>> getOrganization(String id){
    ...
    public ResponseEntity<ApiResponse<Boolean>> deleteOrganization(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Integer>> getStudentCount(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Map>> getStudentCountForEachCourse(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Map>> getInstructorDetailsForEachCourse(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Integer>> getInstructorCount(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Map>> getStudentCourseInstructorByCourse(String id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Object>> getStudentByCourseProgress(String id, String progress){
