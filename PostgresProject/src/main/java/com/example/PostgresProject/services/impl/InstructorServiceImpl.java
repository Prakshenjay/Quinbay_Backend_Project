...
public class InstructorServiceImpl implements InstructorService {
    ...
    public ResponseEntity<ApiResponse<InstructorDTO>> getInstructor(Long id){
    ...
    public ResponseEntity<ApiResponse<Boolean>> deleteInstructor(Long id){
    ...
    @Override
    public ResponseEntity<ApiResponse<Boolean>> enrollCourse(Long instructorId, Long courseId){
    ...
    @Override
    public ResponseEntity<ApiResponse<Boolean>> withdrawCourse(Long instructorId, Long courseId){
    ...
    @Override
    public ResponseEntity<ApiResponse<Boolean>> updateCourseStatus(Long studentId, Long courseId, String status){
