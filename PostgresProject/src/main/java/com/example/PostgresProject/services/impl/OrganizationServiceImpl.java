...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    public ApiResponse<OrganizationDTO> getOrganization(Long id){
    ...
    public ApiResponse<Boolean> deleteOrganization(Long id){
    ...
    @Override
    public ApiResponse<Integer> getStudentCount(Long id){
    ...
    @Override
    public ApiResponse<Map> getStudentCountForEachCourse(Long id){
    ...
    @Override
    public ApiResponse<Map> getInstructorDetailsForEachCourse(Long id){
    ...
    @Override
    public ApiResponse<Integer> getInstructorCount(Long id){
    ...
    @Override
    public ApiResponse<Map> getStudentCourseInstructorByCourse(Long id){
    ...
    @Override
    public ApiResponse<Object> getStudentByCourseProgress(Long id, String progress){
